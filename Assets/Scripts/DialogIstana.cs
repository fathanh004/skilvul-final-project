...
public class DialogIstana : MonoBehaviour
{
    ...
    public UnityEvent onDialog1 = new UnityEvent();
    public UnityEvent onDialog1Done = new UnityEvent();
    ...
    public UnityEvent onTamat = new UnityEvent();
    ...
    public void Dialog1()
    {
        ...
        dialogTexts.Add(new DialogData(originalString: "/color:black/Itu dia raja jin nya", character: "Roro", () => Dialog1Start()));
        dialogTexts.Add(new DialogData(originalString: "/color:black/Kamu bisa melawannya kapan saja ketika kamu sudah siap", character: "Roro", () => Dialog1Done()));
    ...
    public void Dialog4()
    {
        ...
        dialogTexts.Add(new DialogData(originalString: "/color:black/Aku siap", character: "Adit", ()=> Tamat()));
